(function() {
  ...
  ">
    ...
    <nav style="display:flex;gap:28px;align-items:center;margin-left:auto;">
      ...
      <a href="portfolio.html" class="site-nav-link" style="
        ...
        white-space:nowrap;
      ">Portfolio.</a>
      <a href="packages.html" class="site-nav-link" style="
        font-family:'DM Sans',sans-serif;font-size:.78rem;font-weight:700;
        color:rgba(255,255,255,.65);letter-spacing:.04em;
        text-decoration:none;padding-bottom:2px;
        border-bottom:1px solid transparent;
  ...
  function updateHeader() {
    ...
    if (scrolled) {
      ...
      if(motion) motion.style.color = '#1a1a1a';
      if(relay)  relay.style.color  = 'rgba(26,26,26,.5)';
      if(line)   line.style.background = 'rgba(26,26,26,.2)';
      links.forEach(a => {
